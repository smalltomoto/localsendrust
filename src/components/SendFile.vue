<template>
  <div class="p-6 bg-gray-100 min-h-screen">
    ...
    <!-- 拖拽上传区域 -->
    <div class="mt-4 p-6 border-2 border-dashed border-gray-400 rounded-lg text-center cursor-pointer"
    ...
    <!-- 选中文件列表 -->
    <ul class="mt-4">
      <li v-for="file in selectedFiles" :key="file.name" class="p-2 bg-white shadow-md rounded-lg mt-2">
...
const targetDevice = computed(() => ({
  name: deviceStore.selectedDevice.name,
  ip: deviceStore.selectedDevice.ip
}));
